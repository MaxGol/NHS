export const messages = {
  ...
  USER_IS_OVER_18: 'Excellent! Here’s a few more things to consider before we jump in: \n\n🧐 Your number will be stored by us, but we can delete it anytime, just type \'Delete\'.  \n\n🎙Your voice note will also be stored and screened by real humans before sending it over to our NHS heroes. \n\n➡️ We can’t control or stop recipients forwarding on your voice notes to others. But if they are positive messages, hopefully that’s ok. \n\n🔗Check out more details here: thenationalhopeservice.com/privacy-policy \n\nAre you happy to continue? Type \'Yes\' if you are.',
  USER_AGE_INVALID_ANSWER: '🤔 Sorry, I’m not sure I understood you. Just type ‘Yes’ of you are over 18 or ‘No’ if you are not yet 18.',
  USER_CONSENT_YES: 'Time to send a voice note and brighten someone’s day! They won\'t be able to respond but trust us, it’s amazingly powerful for our NHS heroes to actually hear you speaking your support. Over to you... 🎤 \n\nP.S. You\'ll be able to listen to it back before you send it, don\'t worry. \n\nP.P.S. It doesn\'t need to be much...why not record 🎤 *"We love you NHS"* or *"Thanks for your hard work keeping us safe".* Any words of encouragement will go down a treat 🙏',
  ...
  USER_LEFT_VOICE_RECORDING_NOT_CONFIRMED: 'Nice one! Are you happy for this to be shared with our NHS front-line? Type \'Yes\' or \'No\'. You can always record another one if you say \'No\'...',
  DIFFERENT_FILE_TYPE: [
